...
function elvinaa_dynamic_css_stylesheet() {    
    ...
    $heading_hover_color= sanitize_hex_color(get_theme_mod( 'el_heading_hover_color','#54A2CC' ));    

    $button_color= sanitize_hex_color(get_theme_mod( 'el_button_color','#5b9dd9' ));
    $button_hover_color= sanitize_hex_color(get_theme_mod( 'el_button_hover_color','#54A2CC' ));
    ...
    $top_menu_dd_color= sanitize_hex_color(get_theme_mod( 'el_top_menu_dd_color','#2e5a71' ));
    
    //category blinker
    $cat_blinker_color= sanitize_hex_color(get_theme_mod( 'el_cat_blinker_color','#2e5a71' ));    
