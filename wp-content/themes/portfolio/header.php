...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-16325683-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-16325683-2');
</script>
...
<body <?php body_class(); ?>>
    ...
    <?php
       ...
       */
      //                                                 
        if( !is_front_page()) { do_action( 'elvinaa_action_header' ); }
    ?>
    ...
    <?php if( is_front_page()) {
        ...
        if("slider" != esc_attr(get_theme_mod( 'el_slide_options_radio' ))) {
          ...
          <!-- Container --><div class="container homepage-container">
                                    ...
                                    <div class="col-md-12">
                                        <div class="slide-bg-section">
                                            ...
                                            <div class="slide-bg-text">
                                                ...
                                                <div id="custom-logo" class="center">
                                                    
                                                        <!-- custom header logo -->
                                                        <?php dynamic_sidebar('header-logo'); ?>
                                                        
                                                 <h1 class="<?php  echo esc_attr(get_theme_mod( 'el_home_text_position', 'center' )); ?> site-name">
                                                    <?php
                                                ...
                                                <div class="<?php echo esc_attr(get_theme_mod( 'el_home_text_position','center' )); ?> portfolio-description"><?php echo esc_attr(get_theme_mod( 'el_home_subheading_text', get_bloginfo( 'description', 'display' ))); ?></div>                                                    
                                                ...
                                                <div id=""><?php dynamic_sidebar('header-sidebar'); ?></div>
                                                <div id=""><?php dynamic_sidebar('header-navigation'); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
